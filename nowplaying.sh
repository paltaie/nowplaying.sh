#!/bin/bash -e
# To get started, go to https://0c4f393e.us-south.apigw.appdomain.cloud/spotifybash/login to authorise SpotifyBash to access your Now Playing data, and follow the prompts
...
#Declare some vars
TOKEN=$(curl -s https://0c4f393e.us-south.apigw.appdomain.cloud/spotifybash/token?refreshToken=${REFRESH_TOKEN} | jq -r '.access_token')
